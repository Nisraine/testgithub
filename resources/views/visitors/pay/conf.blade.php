...
<body style="background: #fff" >
  ...
  <div class="container" style="width: 63% ;margin-top: 30px ; margin-left: 30% ; margin-bottom: 30px;">
    ...
    <div class="form-container">
        <h2 class="form-title">Check Your Information</h2>
        <form action="" class="checkout-form">
            {{-- ,,,,,,,,,,,,,cards,,,,,,,,,,,,, --}}
            <div class="card-container" style=" ">
                <div class="top-bar">
                    <h3 style="color: #fff" class="bank-name">cart ofppt</h3>
                    <img src="{{asset('assets/img/pay/MCIcon.png' )}}" alt="" class="card-type-icon">
                </div>
                <div class="icons-card">
                    <img src="{{asset('assets/img/pay/Chip.png' )}}" alt="" class="icon">
                    <img src="{{asset('assets/img/pay/CLIcon.png' )}}" alt="" class="icon">
                </div>
                <h3 style="color: #fff" class="card-number">1111 2222 3333 4444</h3>
                <div class="card-info">
                    <div class="name-container">
                        <span style="color: #fff" class="title">Nombre</span>
                        <span class="name">credit card</span>
                    </div>
                    <div class="date-container">
                        <span style="color: #fff" class="title">Visa card</span>
                        <span class="name">03/21</span>
                    </div>
                </div>
               ...
               @empty($record=0)
                @foreach($card->getDetails()->get('items') as $data)
                <a class="button" href="{{route('c_insert',['id'=>$data->id])}}">Shopping Now</a>
                @if ($record =1)
                    @break
                @endif
                @endforeach
