...
<div id="comment-{{ $comment->getKey() }}" class="media" style="background: rgba(255, 255, 255, 0)">
    ...
    <div class="media-body">
        ...
        @can('reply-to-comment', $comment)
            <div class="modal fade" id="reply-modal-{{ $comment->getKey() }}" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('comments.reply', $comment->getKey()) }}" style="background: rgba(255, 255, 255, 0)">
                            @csrf
                            <div class="modal-header" style="background: rgba(255, 255, 255, 0)">
