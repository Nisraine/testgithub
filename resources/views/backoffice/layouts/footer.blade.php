        ...
        <div class="ms-quickbar-container ms-scrollable">
          ...
          <div class="ms-card ms-qa-card ms-deletable">
            ...
            <div class="ms-card-body">
              ...
              <ul class="ms-note-members clearfix mb-0">
                <li class="ms-deletable"> <img src="assetss/img/people/people-3.jpg" alt="member"> </li>
                <li class="ms-deletable"> <img src="assetss/img/people/people-5.jpg" alt="member"> </li>
              </ul>
            </div>
            <div class="ms-card-footer clearfix">
                  ...
                  <li class="ms-scrollable ms-dropdown-list ms-members-list">
                    <a class="media p-2" href="#">
                      <div class="mr-2 align-self-center">
                        <img src="assetss/img/people/people-10.jpg" class="ms-img-round" alt="people">
                      </div>
                    ...
                    <a class="media p-2" href="#">
                      <div class="mr-2 align-self-center">
                        <img src="assetss/img/people/people-9.jpg" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body">
                    ...
                    <a class="media p-2" href="#">
                      <div class="mr-2 align-self-center">
                        <img src="assetss/img/people/people-7.jpg" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body">
          ...
          <div class="ms-card ms-qa-card ms-deletable">
            ...
            <div class="ms-card-body">
              ...
              <ul class="ms-note-members clearfix mb-0">
                <li class="ms-deletable"> <img src="assetss/img/people/people-9.jpg" alt="member"> </li>
              </ul>
            </div>
            <div class="ms-card-footer clearfix">
...
<script src="{{asset('assetss/js/jquery-3.5.0.min.js')}}"></script>
<script src="{{asset('assetss/js/popper.min.js')}}"></script>
<script src="{{asset('assetss/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assetss/js/perfect-scrollbar.js')}}">
</script>
<script src="{{asset('assetss/js/jquery-ui.min.js')}}">
</script>
<!-- Global Required Scripts End -->
<!-- Page Specific Scripts Start -->

<script src="{{asset('assetss/js/Chart.bundle.min.js')}}">
</script>
<script src="{{asset('assetss/js/widgets.js')}}"> </script>
<script src="{{asset('assetss/js/clients.js')}}"> </script>
<script src="{{asset('assetss/js/Chart.Financial.js')}}"> </script>
<script src="{{asset('assetss/js/d3.v3.min.js')}}">
</script>
<script src="{{asset('assetss/js/topojson.v1.min.js')}}">
</script>
<script src="{{asset('assetss/js/datatables.min.js')}}">
</script>
<script src="{{asset('assetss/js/data-tables.js')}}">
</script>
<!-- Page Specific Scripts Finish -->
<!-- Costic core JavaScript -->
<script src="{{asset('assetss/js/framework.js')}}"></script>
<!-- Settings -->
